...
import { LoginTreeSvgProps } from "../../types/loginTreeSvgProps";

const LoginTreeSvg: React.FC<LoginTreeSvgProps> = ({
  percentageSize = 100,
}) => {
  return (
    <div
      className="animated-svg-container"
      style={{ maxWidth: `${percentageSize}%` }}
    >
      <svg
